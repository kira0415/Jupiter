...
/**
 * This class encoding the input latitude and longitude into geoPoint
 * @author Kira
 * @version 1.0
 */
public class GeoHash {
	...
	/**
	 * encoding latitude and longitude value into geoPoint
	 * @param latitude - latitude of location
	 * @param longitude - longitude of location
	 * @param precision - 
	 * @return the string code representing the geoPoint
	 */
